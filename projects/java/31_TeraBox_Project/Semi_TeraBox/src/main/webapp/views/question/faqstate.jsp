		...
		<div class="qt-mainarea-by">
			<nav id="qt_sidebar-area_by" class="qt-sidebar-areapoint-by">
				...
				<ul>
					...
					<li><a class="qt-second-text-by" href="${ path }/question/faq">자주 묻는 질문</a></li>
					...
					<ul>
						...
						<li>
							<button type="button" class="qt-btn-by qt-tabBtn-by"
								...
								<a class="qt-acolor1-by"
									href="${ path }/question/faqmovie">영화
									예매</a>
							</button>
						</li>
						<li class="qt-on-by">
							<button type="button" class="qt-btn-by qt-tabBtn-by"
								...
								<a class="qt-acolor-by"
									href="${ path }/question/faqcinema"></a>극장/특별관
							</button>
						</li>
					</ul>
				</div>
				<div class="qt-faq-list-box-by">
					...
					<div class="qt-faq-list-by">
						<ul>
							...
							<li>
								<div class="qt-qut-by">
									<a href="javascript:void(0);" onclick="return false;" class="qt-qut-by-a">
										<p class="qt-tit-by">
