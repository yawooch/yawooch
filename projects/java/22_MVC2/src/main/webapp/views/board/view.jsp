            ...
            <tr>
                ...
                <td>
                    ...
                    <c:if test="${not empty board.originalFilename}">
                        ...
                        <span style="color: gray;">${board.originalFilename}</span>
                        </a>
                        
<%--                         <a href="${path}/resources/upload/board/${board.renamedFilename}" id="fileDown" --%>
...
<!--                         </a> -->
            ...
            <tr>
                ...
                <c:if test="${not empty loginMember && loginMember.id == board.writerId }">
                    <button type="button" onClick="location.href='${path}/board/update?no=${board.writerNo}'">수정</button>
                    <button type="button">삭제</button>
                </c:if>
                    <button type="button" onClick="location.href='${path}/board/list?page=1'">목록으로</button>
                </th>
            </tr>
        </table>
...
fileDown.addEventListener('click',function(event){
