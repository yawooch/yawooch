        ...
        <div class="member-content member-login">
            <form action="${ path }/login" id="login-form" method="post">
                ...
                <div id="biglogo" onclick="location.href='${path}/'">
                    <img src="${ path }/img/member/big_logo.png" alt="로고"
                        style="width: 250px" />
                </div>
                <!--로그인 창-->
                <div class="first_div">
                    <div class="login-box">
                        <input type="text" name="memberId"
                            value="${ cookie.saveId.value }" id="input_id" placeholder="아이디" />
                        <br /> <input type="password" name="memberPw" id="input_pass"
                            placeholder="비밀번호" />
                        <div class="login_info_save">
                            <!-- 아이디 저장 체크박스 -->
                            <input type="hidden" id="saveId" name="saveId"
                                value="${empty cookie.saveId ? " false" : "true"}" /> <input
                                type="checkbox" id="login_info_save"
                                ${ empty cookie.saveId ? "" : "checked" } /> <label
                                for="login_info_save">아이디 저장</label>
                        </div>
