...
<div class="content">
    <div class="container">
        ...
        <div class="common-list">
            ...
            <div class="community-detail-list">
                ...
                <table border="1">
                    <tr>
                        ...
                        <td colspan="5" class="community-td-title"
                            style="text-align: left;">${ community.communityCategory }
                            ${ community.communityTitle }</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="6" class="community-td-content"
                            style="text-align: left;"><c:if
                                test="${ community.communityRfileName == null }">
                                ${ community.communityContent }
                            </c:if> <c:if test="${ community.communityRfileName != null }">
                                <p>
                                    <img style="max-width: 800px; max-height: 800px;"
                                        src="${ path }/resources/upload/community/${ community.communityRfileName }"
                                        alt="">
                                </p>
                                ${ community.communityContent }
                            </c:if></td>
                    ...
                    <tr>
                        ...
                        <c:if test="${ not empty community.communityOfileName }">
                            <td colspan="5" style="text-align: left;"><a id="fileDown">${ community.communityOfileName }</a>
                            </td>
                        </c:if>
                    </tr>
                </table>
            ...
            <div class="btn-wrap">
                <c:if
                    test="${ loginMember.memberId != community.communityWriterId }">
                    <button class="community-btn"
                        onclick="location.href='${ path }/community/board/mypet'">목록</button>
                </c:if>
                <c:if
                    test="${ loginMember.memberId == community.communityWriterId }">
